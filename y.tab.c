...
{
       0,     0,     3,     6,     8,    12,    16,    19,    22,    25,
      28,    32,    36,    38,    42,    46,    48,    50,    52
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      19,     0,    -1,    19,    20,    -1,    20,    -1,    11,    16,
      10,    -1,    12,    17,    10,    -1,    13,    10,    -1,    21,
      10,    -1,    14,    10,    -1,    15,    10,    -1,    21,     3,
      22,    -1,    21,     4,    22,    -1,    22,    -1,    22,     5,
      23,    -1,    22,     6,    23,    -1,    23,    -1,    16,    -1,
      17,    -1,     8,    21,     9,    -1
};
...
{
       0,    94,    94,    94,    96,    97,   107,   108,   113,   114,
     120,   130,   139,   142,   151,   160,   163,   169,   180
};
#endif
...
static const char *const yytname[] =
{
  ...
  "EQUAL", "LPAREN", "RPAREN", "SEMICOLON", "SHOW", "SELECT", "EXIT",
  "EVALUATE", "GET", "IDENTIFIER", "NUMBER", "$accept", "lines", "line",
  "expr", "term", "factor", 0
};
#endif
...
static const yytype_uint8 yydefact[] =
{
       ...
       3,     0,    12,    15,     0,     0,     0,     6,     8,     9,
       1,     2,     0,     0,     7,     0,     0,    18,     4,     5,
      10,    11,    13,    14
};
...
{
      10,    -7,     3,    15,    23,    24,    28,   -20,   -20,     0,
     -20,    25,    -3,   -20,    27,    29,    30,   -20,   -20,   -20,
     -20,   -20,    -7,    -7,   -20,    -7,    -7,   -20,   -20,   -20,
      -3,    -3,   -20,   -20
};
...
{
      20,     1,    25,    26,    30,    31,    32,    33,     1,     7,
       8,     2,     3,     4,     5,     6,     7,     8,     1,    15,
      21,     2,     3,     4,     5,     6,     7,     8,    22,    23,
      22,    23,    16,    17,    18,    24,    27,    14,    19,    28,
      29
};

static const yytype_uint8 yycheck[] =
{
       0,     8,     5,     6,    22,    23,    25,    26,     8,    16,
      17,    11,    12,    13,    14,    15,    16,    17,     8,    16,
       9,    11,    12,    13,    14,    15,    16,    17,     3,     4,
       3,     4,    17,    10,    10,    10,     9,     1,    10,    10,
      10
};
...
{
       0,     8,    11,    12,    13,    14,    15,    16,    17,    19,
      20,    21,    22,    23,    21,    16,    17,    10,    10,    10,
       0,    20,     3,     4,    10,     5,     6,     9,    10,    10,
      22,    22,    23,    23
};
  ...
  switch (yyn)
    {
        case 4:
#line 96 "index.y"
    {showTBdata(conn,(yyvsp[(2) - (3)].cur_string));}
    break;
...
#line 97 "index.y"
    {
                                                ...
                                                stream << std::fixed << std::setprecision(2) << (yyvsp[(2) - (3)].cur_num);
                                                id += stream.str();
...
#line 120 "index.y"
    {
                                                string pTempOP = "";
                                                pTempOP += (yyvsp[(1) - (3)].cur_string);
                                                pTempOP += " + "; 
                                                pTempOP += (yyvsp[(3) - (3)].cur_string); 
                                                

                                                (yyval.cur_string) = new char [pTempOP.length() + 1];
                                                strcpy((yyval.cur_string),pTempOP.c_str());
                                            }
    break;
...
#line 130 "index.y"
  ...
  case 12:
#line 139 "index.y"
    {(yyval.cur_string) = (yyvsp[(1) - (1)].cur_string);}
    break;
...
#line 163 "index.y"
    {
                                                string curStrABID = getValue((yyvsp[(1) - (1)].cur_string));

                                                (yyval.cur_string) = new char [curStrABID.length() + 1];
                                                strcpy((yyval.cur_string),curStrABID.c_str());
                                            }
    break;
...
#line 169 "index.y"
    {
                                                ...
                                                std::stringstream stream;
                                                stream << std::fixed << std::setprecision(2) << (yyvsp[(1) - (1)].cur_num);
                                                tempNum += stream.str();

                                                (yyval.cur_string) = new char [tempNum.length() + 1];
                                                strcpy((yyval.cur_string),tempNum.c_str());
                                            }
    break;
...
#line 180 "index.y"
    {
                                                string pSubExpr = "(";
                                                pSubExpr += (yyvsp[(2) - (3)].cur_string);
                                                pSubExpr += ")";

                                                (yyval.cur_string) = new char [pSubExpr.length() + 1];
                                                strcpy((yyval.cur_string),pSubExpr.c_str());

                                                cout << (yyval.cur_string) << "\n";
                                            }
    break;
...
void get () {
    ...
    cout << "KEEP DEFAULT RESULT TABLE AS: " << selected_table <<"?(0/1)";
    int flag_change = 0;
    cin >> flag_change;
